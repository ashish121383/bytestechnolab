...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		// This is plugin activator contact form 7
		array(
			'name' 	 => 'Contact Form 7',
			'slug'   => 'contact-form-7',
			'source' => get_stylesheet_directory().'/plugins/contact-form-7.5.1.7.zip',
			'required' => true,
		...
		array(
			'name' 	 => 'Woocommerce',
			'slug'   => 'woocommerce',
			'source' => get_stylesheet_directory().'/plugins/woocommerce.zip',
			'required' => true,
